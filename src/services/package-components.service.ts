...
export class PackageComponentsService {
    ...
    /**
     * @desc Get all components under a package
     */
    ...
    /**
     * @desc Create a new package component
     */
    ...
    /**
     * @desc Update a package component
     */
    ...
    /**
     * @desc Delete a package component
     */
    async delete(params: { componentId: string }): Promise<IDBPackageComponentRow> {
        ...
        if (error || !data) throw new BadRequestError(error?.message || 'Failed to delete package component');
        return data;
    }

    /**
     * @desc Get component by ID or throw error
     */
